...
public class ArbitrageDetection {
    ...
    public static void main(String[] args) {
        ...
        //verticalG.addEdge(new DirectedWeightedEdge(0, 0, 1));
        ...
        //verticalG.addEdge(new DirectedWeightedEdge(1, 1, 0));
        ...
        //verticalG.addEdge(new DirectedWeightedEdge(2, 2, 1));
        ...
        //verticalG.addEdge(new DirectedWeightedEdge(3, 3, 1));
        ...
        //verticalG.addEdge(new DirectedWeightedEdge(4, 4, 1));

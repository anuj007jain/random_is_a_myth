...
public class LC_0807_Max_Increase_To_Keep_City_Skyline {
    ...
    public static void main(String[] args) {
        int[][] grid = {{3, 0, 8, 4}, {2, 4, 5, 7},
                {9, 2, 6, 3}, {0, 3, 1, 0}};
        LC_0807_Max_Increase_To_Keep_City_Skyline lc_807_mitkcs = new LC_0807_Max_Increase_To_Keep_City_Skyline();

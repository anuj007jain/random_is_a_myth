...
public class LC_0980_Unique_Paths_III {

    public static int count = 0;

    public static void main(String[] args) {
        LC_0980_Unique_Paths_III lc_0980_unique_paths_iii = new LC_0980_Unique_Paths_III();
        int[][] grid = new int[3][4];
        grid[0][0] = 1;
        grid[2][2] = 2;
        grid[2][3] = -1;
        lc_0980_unique_paths_iii.uniquePathsIII(grid);
